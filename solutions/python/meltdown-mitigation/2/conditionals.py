...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    """
    temperature_flux = temperature*neutrons_produced_per_second
    normal_percentage = 0.1 * threshold
    
    if temperature_flux < 0.9 * threshold:
        return 'LOW'
    elif temperature_flux >= threshold - normal_percentage and temperature_flux <= threshold + normal_percentage:
        return 'NORMAL'
    else:
        return 'DANGER'
